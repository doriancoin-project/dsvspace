...
init();`;
  ...
  wrapCommonJS(code: any) {
    ...
    if (code.codeTemplate) {
      ...
      const importText = `<script src="https://blocks.doriancoin.com/mempool.js"></script>`;
...
yarn add @mempool/mempool.js`;
  ...
  wrapPythonTemplate(code: any) {
    return ( ( this.network === 'testnet' ) ? ( code.codeTemplate.python.replace( 'wss://blocks.doriancoin.com/api/v1/ws', 'wss://blocks.doriancoin.com/' + this.network + '/api/v1/ws' ) ) : code.codeTemplate.python );
  }
