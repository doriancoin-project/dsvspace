...
export class GroupPreviewComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.seoService.setTitle(`blocks.doriancoin.com Lightning Nodes`);
      ...
      .pipe(
        switchMap((params: ParamMap) => {
          ...
          if (this.slug === 'the-mempool-open-source-project') {
            this.groupId = 'blocks.doriancoin.com';
            this.group = {
              name: 'Doriancoin Project',
              description: 'These are the Lightning nodes operated by Doriancoin Project that provide data for the blocks.doriancoin.com website. Connect to us!',
            };
          } else {
            this.group = {
